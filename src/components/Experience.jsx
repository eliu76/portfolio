...
const EXPERIENCE = [
    ...
    team: "Bloom TPU Engineering",
    period: "April 2026 – Present",
    location: "Sunnyvale, CA",
    type: "full-time",
    tags: ["Python", "Go", "CloudSQL"],
    bullets: [
      "Part of the Bloom TPU Engineering team under Google Cloud supporting expansion of their AI Infrastructure.",
    ],
  },
  {
    company: "Capital One",
